...
namespace Word_Analyzer
{
	...
	public class BayesianSearch
	{
		...
		public BayesianSearch(List<string> answers, List<string> guesses = null)
		{
			...
			this.guesses = (guesses == null || !guesses.Any()) ? this.answers : guesses;
		...
		public string Run()
		{
			...
			foreach (string guess in guesses)
			{
				...
				if (score > bestScore || (Math.Abs(score - bestScore) < 1e-9 && best != null && string.CompareOrdinal(guess, best) < 0))
				{
					bestScore = score;
					best = guess;
				}
